package com.bt.arasholding.filloapp.ui.barcodeexample;
...
public class BarcodeExampleActivity extends AppCompatActivity {
    ...
    public static Intent getStartIntent(Context context) {
        Intent intent = new Intent(context, BarcodeExampleActivity.class);
        return intent;
    }
                            ...
                            for (int i = 0; i < bytesAvailable; i++) {
                                ...
                                if (b == delimiter) {
                                    ...
                                    handler.post(new Runnable() {
                                        public void run() {
                                            Toast.makeText(BarcodeExampleActivity.this, data, Toast.LENGTH_SHORT).show();
